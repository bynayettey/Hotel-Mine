...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					...
					<li><i class="fa fa-phone" aria-hidden="true"></i>+91 95222-44-554</li>	
					<li><i class="" aria-hidden="true"></i><a href="admin/index.jsp"><b>Admin Login</b></a></li>	
					<li class="s-bar">
						<div class="search">
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.jsp">SUN <span>RISE</span><p class="logo_w3l_agile_caption">Your Dreamy Resort</p></a></h1>
				</div>
...
<div class="col-md-12 book-form-left-w3layouts">
	<a href="admin/reservation.jsp"><h2>ROOM RESERVATION</h2></a>
</div>
			 ...
			 <div class="col-md-6 advantage-grid left-w3ls wow bounceInLeft" data-wow-delay="0.3s">
			 	<div class="advantage-block ">
					<i class="fa fa-credit-card" aria-hidden="true"></i>
			 		...
			 		<p>We have the very new and exclusive facility of Pay Later. Pay later facility has some term and conditions. Please do notice.</p>
			 ...
			 <div class="col-md-6 advantage-grid right-w3ls wow zoomIn" data-wow-delay="0.3s">
			 	<div class="advantage-block">
					<i class="fa fa-clock-o" aria-hidden="true"></i>
			 		...
			 		<p>We are providing 24 hours of service without any question. Ask for service and you will be offered with no any single question.</p>
			...
			<div id="horizontalTab">
					...
					<div class="tab1">
						...
						<div class="col-md-6 team-Info-agileits">
							<h4>Lucas Jimenez</h4>
							<span>Manager</span>
							<p>He is Responsible for managing employees and for planning, marketing , coordinating and administering hotel services such as catering and accommodation facilities.</p>
					...
					<div class="col-md-6 team-img-w3-agile">
						...
						<div class="col-md-6 team-Info-agileits">
							...
							<p>Serves visitors by greeting, welcoming, and directing them appropriately.Maintains security and telecommunications system.Informs visitors by answering or referring inquiries.Keeps a safe and clean reception area by complying with procedures, rules, and regulations.</p>	
						<div class="social-bnr-agileits footer-icons-agileinfo">
							<ul class="social-icons3">
								<li><a href="#" class="fa fa-facebook icon-border facebook"> </a></li>
								<li><a href="#" class="fa fa-twitter icon-border twitter"> </a></li>
					...
					<div class="price-block agile">
						...
						<div class="price-gd-bottom">
							...
							<div class="price-selet">	
								...
								<a href="admin/reservation.jsp" >Book Now</a>
							</div>
						</div>
					</div>
				</div>
					...
					<ul class="slides">
						<li>
							...
							<div class="w3layouts_work_grid_right">
								...
								<p>Fabulous five-star service in a five-minute timeframe. 
									very good system to pre-register the guest online. 
									visitor gets a temporary wi-fi password. visitors look and feel their best. Thats why I loved it.</p>
								<h5>Julia Rose</h5>
								<p>Germany</p>
							</div>
							<div class="clearfix"> </div>
	...
	<div class="container">
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile2" data-aos="flip-left">
			<div class="contact-agileits">
				...
				<form  method="post" name="sentMessage" id="contactForm" action="index.jsp">
				...
				if(request.getParameter("sub")!=null)
				{
					...
					if(i>0){
						out.print("OK");%>
						<script type='text/javascript'> alert("You Have Sign Up for Newsletter successfully.")</script>
					<%}
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+91 (95)222-44-554</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">INFO@SUNRISE.COM</a></p>
			<p class="contact-agile1"><strong>Address :</strong> New Kalmunai Road, Mathura, India</p>
...
<!-- /contact -->
			<div class="copy">
		        <p>© 2020-2021 SUNRISE . All Rights Reserved | Design by <a href="index.jsp">SUNRISE</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
